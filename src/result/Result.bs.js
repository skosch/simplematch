...
function make(currentState, resultData, _) {
  var statistics = function () {
    ...
    var selectorsMatched = Belt_List.reduce(currentState[/* selectingParsedData */9], 0, (function (p, c) {
            var match = Belt_HashMapString.has(matchedNames, c[/* name */0]);
            return p + (
                    match ? 1 : 0
                  ) | 0;
          }));
    var selecteesMatched = Belt_List.reduce(currentState[/* selectedParsedData */10], 0, (function (p, c) {
            var match = Belt_HashMapString.has(matchedNames, c[/* name */0]);
            return p + (
                    match ? 1 : 0
                  ) | 0;
